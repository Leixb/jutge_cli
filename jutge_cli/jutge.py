...
parser_show = subparsers.add_parser('show', help='show title, statement or test cases corresponding to problem code', parents=[parent_parser])
...
parser_update = subparsers.add_parser('update', help='add programs to archived folder from zip file', parents=[parent_parser])
...
parser_download = subparsers.add_parser('download', help='download problem files to local database', parents=[parent_parser])
...
parser_cookie.add_argument('cookie', metavar='PHPSESSID', help='cookie to save (set to delete to delete saved cookie)')
