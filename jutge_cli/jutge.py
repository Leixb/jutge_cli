...
parent_parser.add_argument('-r','--regex',type=str, help='Regex used to find the code from filename', default=config['regex'])
parent_parser.add_argument('--no-download', action='store_true', help='Do not attempt to fetch data from jutge.org')
parent_parser.add_argument('--cookie', metavar='PHPSESSID', type=str, help='Cookie used to fetch data from jutge.org')
...
parser_add_test = subparsers.add_parser('add-test', help='Add custom test-case to database', parents=[parent_parser])
...
parser_show = subparsers.add_parser('show', help='Show title,statement or public cases corresponding to problem code', parents=[parent_parser])
...
parser_archive = subparsers.add_parser('archive', help='Move program to archived folder', parents=[parent_parser])
...
parser_update = subparsers.add_parser('update', help='Add programs to Archived folder fom zip file', parents=[parent_parser])
...
parser_new = subparsers.add_parser('new', help='Create new file', parents=[parent_parser])
...
parser_download = subparsers.add_parser('download', help='Download to DB', parents=[parent_parser])
...
parser_cookie = subparsers.add_parser('cookie', help='Save cookie to tmp', parents=[parent_parser])
