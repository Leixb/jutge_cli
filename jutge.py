...
parser_test.add_argument('prog',metavar='prog.cpp',type=argparse.FileType('rx'), help='Program to test')
...
parser_download_mex.add_argument('-p','--prog',metavar='prog.cpp',type=argparse.FileType('rx'), help='Program to test')
